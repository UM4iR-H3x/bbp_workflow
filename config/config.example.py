"""
Example configuration file for the Ultimate Automated Recon + Leak Detection Framework
...
# Set these environment variables or replace with your webhook URLs
DISCORD_WEBHOOKS = {
    "js_leaks": os.getenv("DISCORD_WEBHOOK_JS", ""),
    "env_exposure": os.getenv("DISCORD_WEBHOOK_ENV", ""),
    "git_exposure": os.getenv("DISCORD_WEBHOOK_GIT", ""),
    "cors": os.getenv("DISCORD_WEBHOOK_CORS", "")
}
